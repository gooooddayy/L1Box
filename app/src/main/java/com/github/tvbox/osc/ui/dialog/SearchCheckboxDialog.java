    ...
    protected void initView() {
        ...
        checkAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 已全选则全不选,否则全选
                boolean allChecked = mCheckSourcees != null && mCheckSourcees.size() >= mSourceList.size();
        ...
        clearAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(SourceBean sourceBean : mSourceList) {
                    if (mCheckSourcees == null || !mCheckSourcees.containsKey(sourceBean.getKey())) {
                        inverted.put(sourceBean.getKey(), "1");
                    }
                }
                mCheckSourcees = inverted;
                checkboxSearchAdapter.setData(mSourceList, mCheckSourcees);
            }
        });
    }
