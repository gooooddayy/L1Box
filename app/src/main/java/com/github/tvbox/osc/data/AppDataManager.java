    ...
    static final Migration MIGRATION_2_3 = new Migration(2, 3) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            ...
            while (cursor.moveToNext()) {
                ...
                // 参数化插入：dataJson 含单引号(影片标题撇号)时字符串拼接会抛 SQLException 导致迁移崩溃
                database.execSQL(
                        "INSERT INTO vodRecordTmp (id, vodId, updateTime, sourceKey, dataJson, testMigration) VALUES (?,?,?,?,?,0)",
                        new Object[]{id, vodId, updateTime, sourceKey, dataJson});
            }
